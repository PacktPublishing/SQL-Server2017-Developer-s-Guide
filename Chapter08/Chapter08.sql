...
BACKUP DATABASE SQLDevGuideDemoDb
 TO DISK = N'C:\SQL2017DevGuide\SQLDevGuideDemoDb_Backup.bak'
 WITH INIT;
GO

-- Backup with encryption
BACKUP DATABASE SQLDevGuideDemoDb 
 TO DISK = N'C:\SQL2017DevGuide\SQLDevGuideDemoDb_BackupEncrypted.bak'  
WITH INIT,
 ENCRYPTION   
  (  
   ALGORITHM = AES_256,  
...
BACKUP SERVICE MASTER KEY
 TO FILE = N'C:\SQL2017DevGuide\SMK.key'   
 ENCRYPTION BY PASSWORD = 'Pa$$w0rd';  
-- Backup master DMK
BACKUP MASTER KEY
 TO FILE = N'C:\SQL2017DevGuide\masterDMK.key'   
 ENCRYPTION BY PASSWORD = 'Pa$$w0rd'; 
-- Backup certificate
BACKUP CERTIFICATE DemoBackupEncryptCert
 TO FILE = N'C:\SQL2017DevGuide\DemoBackupEncryptCert.cer'
 WITH PRIVATE KEY
  (
   FILE = N'C:\SQL2017DevGuide\DemoBackupEncryptCert.key',
   ENCRYPTION BY PASSWORD = 'Pa$$w0rd'
  );
GO
...
RESTORE DATABASE SQLDevGuideDemoDb
 FROM  DISK = N'C:\SQL2017DevGuide\SQLDevGuideDemoDb_BackupEncrypted.bak'
 WITH  FILE = 1;
GO
...
-- Restore master DMK
RESTORE MASTER KEY   
 FROM FILE = N'C:\SQL2017DevGuide\masterDMK.key' 
...
CREATE CERTIFICATE DemoBackupEncryptCert  
 FROM FILE = N'C:\SQL2017DevGuide\DemoBackupEncryptCert.cer'
 WITH PRIVATE KEY (FILE = N'C:\SQL2017DevGuide\DemoBackupEncryptCert.key',
                   DECRYPTION BY PASSWORD = 'Pa$$w0rd');  
GO 
...
USE master;
!!del C:\SQL2017DevGuide\DemoBackupEncryptCert.cer
!!del C:\SQL2017DevGuide\DemoBackupEncryptCert.key
!!del C:\SQL2017DevGuide\masterDMK.key
!!del C:\SQL2017DevGuide\SMK.key
!!del C:\SQL2017DevGuide\SQLDevGuideDemoDb_Backup.bak
!!del C:\SQL2017DevGuide\SQLDevGuideDemoDb_BackupEncrypted.bak
GO
