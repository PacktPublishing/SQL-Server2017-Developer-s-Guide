...
BACKUP CERTIFICATE DemoTDEEncryptCert
 TO FILE = N'C:\SQL2017DevGuide\DemoTDEEncryptCert.cer'
 WITH PRIVATE KEY
  (
   FILE = N'C:\SQL2017DevGuide\DemoTDEEncryptCert.key',
   ENCRYPTION BY PASSWORD = 'Pa$$w0rd'
  );
GO
...
USE master;
!!del C:\SQL2017DevGuide\DemoTDEEncryptCert.cer
!!del C:\SQL2017DevGuide\DemoTDEEncryptCert.key
